...
def get_groundtruth(term_wikifreq, term_nytfreq, wikifreq_threshold, nytfreq_threshold):
	splitter = '=||='
	groundtruth = set()
...
def eval(filename, wikifreq_threshold=100, nytfreq_threshold=200):
	freqfilename = './data/wiki.nyt.freq'
	term_wikifreq, term_nytfreq = get_freq(freqfilename)
	groundtruth = get_groundtruth(term_wikifreq, term_nytfreq, wikifreq_threshold, nytfreq_threshold)
	correct = 0
	pnum = 0
